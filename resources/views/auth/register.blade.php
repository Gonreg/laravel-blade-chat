...
<section class="flex bg-gray-50 dark:bg-gray-900 h-screen items-center justify-center">
    <form method="post" action="/api/auth/register" class="flex flex-col w-1/4 justify-center gap-y-2 justify-center">
        @csrf
        <input name="name" type="text" class="flex rounded bg-gray-300/10 cursor-pointer p-2.5 hover:bg-gray-300" placeholder="Введите свое имя">
        ...
        <div class="flex flex-row w-full self-center gap-x-2.5">
            <button class="flex rounded bg-gray-300/50 w-full cursor-pointer p-2.5 hover:bg-gray-300 justify-center">Зарегистрироваться</button>
